...
@SakerTest
public class BinaryNameTest extends MSVCTestCase {
	private static final SakerPath PATH_MAINCPP_OBJ = PATH_BUILD_DIRECTORY
			.resolve("saker.msvc.ccompile/default/x64/main.cpp.obj");
	private static final SakerPath PATH_EXE = PATH_BUILD_DIRECTORY.resolve("saker.msvc.clink/default/x64/My Executable.exe");
	private static final SakerPath PATH_WINMD = PATH_BUILD_DIRECTORY
			.resolve("saker.msvc.clink/default/x64/My Executable.winmd");
